        ...
        <Center height={"100vh"}>
          <Card p={{base:"4",md:"10"}} showCard={true} >
              <VStack spacing={6}>
                  ...
                  <Text textStyle={"p2"} color={"black.60"} textAlign={"center"}>We have sent instructions on how to reset your password to <Box as="b" color='p.black'>jenny.wilson@gmail.com</Box>. Please follow the instructions from the email.
                  </Text>
              </VStack>
